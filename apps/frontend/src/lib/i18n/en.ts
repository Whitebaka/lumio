...
export const en = {
  ...
  printShop: {
    ...
    orderPrintBulk: "Order print ({count} photos)",
    ...
    quantity: "Quantity",
    quantityPerPhoto: "Quantity (per photo)",
    perUnitAtQuantity: "at {quantity} pcs.: {price}/pc.",
    fromPrice: "from {price}",
    cropHint: "Move the frame or drag the corners to choose your crop.",
    bulkCropHint:
      "Crop isn't available when ordering several photos at once — each one keeps its default framing. Add a photo on its own to customize its crop.",
    selectModeEnter: "Select multiple",
    selectModeExit: "Done selecting",
    selectModeHint: "Tap photos to select them, then add them all at once.",
  ...
  printProducts: {
    ...
    pricingMode: "Pricing",
    pricingModeFlat: "Fixed price",
    pricingModeTiered: "Quantity-based pricing (tiers)",
    ...
    tierLadderErrorEnd: "The last tier must be unbounded (leave 'to qty.' empty).",
    tierLadderErrorGap:
  ...
  printImport: {
    navButton: "Import catalog",
    title: "Import print catalog",
    intro:
      "Upload a JSON file to bulk-create or update your product catalog. Download the template below, fill it in, and upload it here.",
    downloadTemplate: "Download template",
    providerLabel: "Provider",
    chooseFile: "Choose file",
    invalidJson: "This file isn't valid — check it against the template and try again.",
    analyzing: "Analyzing…",
    summaryProducts: "Products",
    summaryVariants: "Variants",
    summaryCreatedUpdated: "Created / updated",
    summarySkippedWarnings: "Skipped / warnings",
    noRows: "No rows in this file.",
    ...
    rowStatusWouldCreate: "will be created",
    rowStatusWouldUpdate: "will be updated",
    rowStatusSkippedError: "skipped — needs fixing",
  },
  ...
  orderDetail: {
    ...
    paymentReferencePrompt: "Receipt or invoice reference for this payment:",
    paymentReferencePlaceholder: "e.g. invoice number",
    ...
    imageLabel: "Image:",
    cropLabel: "Crop:",
    cropNotApplied: "cropped file not rendered yet — available once the order is paid",
    cropDownload: "download cropped print file",
    cropRenderFailed: "cropped file could not be rendered — crop manually",
